package com.shaan_snaps_apps.shaan_share.service;
...
import com.shaan_snaps_apps.shaan_share.app.Service;
...
import com.shaan_snaps_apps.shaan_share.exception.AssigneeNotFoundException;
import com.shaan_snaps_apps.shaan_share.exception.ConnectionNotFoundException;
import com.shaan_snaps_apps.shaan_share.exception.DeviceNotFoundException;
import com.shaan_snaps_apps.shaan_share.exception.TransferGroupNotFoundException;
import com.shaan_snaps_apps.shaan_share.fragment.FileListFragment;
import com.shaan_snaps_apps.shaan_share.object.NetworkDevice;
import com.shaan_snaps_apps.shaan_share.object.TextStreamObject;
import com.shaan_snaps_apps.shaan_share.object.TransferGroup;
import com.shaan_snaps_apps.shaan_share.object.TransferInstance;
import com.shaan_snaps_apps.shaan_share.object.TransferObject;
import com.shaan_snaps_apps.shaan_share.util.AppUtils;
import com.shaan_snaps_apps.shaan_share.util.CommunicationBridge;
import com.shaan_snaps_apps.shaan_share.util.CommunicationNotificationHelper;
import com.shaan_snaps_apps.shaan_share.util.DynamicNotification;
import com.shaan_snaps_apps.shaan_share.util.FileUtils;
import com.shaan_snaps_apps.shaan_share.util.HotspotUtils;
import com.shaan_snaps_apps.shaan_share.util.NetworkDeviceLoader;
import com.shaan_snaps_apps.shaan_share.util.NetworkUtils;
import com.shaan_snaps_apps.shaan_share.util.NotificationUtils;
import com.shaan_snaps_apps.shaan_share.util.NsdDiscovery;
import com.shaan_snaps_apps.shaan_share.util.TimeUtils;
import com.shaan_snaps_apps.shaan_share.util.TransferUtils;
import com.shaan_snaps_apps.shaan_share.util.UpdateUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.shaan_snaps_apps.shaan_share.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.shaan_snaps_apps.shaan_share.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.shaan_snaps_apps.shaan_share.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.shaan_snaps_apps.shaan_share.action.IP";
    public static final String ACTION_END_SESSION = "com.shaan_snaps_apps.shaan_share.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.shaan_snaps_apps.shaan_share.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.shaan_snaps_apps.shaan_share.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.shaan_snaps_apps.shaan_share.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.shaan_snaps_apps.shaan_share.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.shaan_snaps_apps.shaan_share.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.shaan_snaps_apps.shaan_share.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.shaan_snaps_apps.shaan_share.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.shaan_snaps_apps.shaan_share.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.shaan_snaps_apps.shaan_share.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.shaan_snaps_apps.shaan_share.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.shaan_snaps_apps.shaan_share.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.shaan_snaps_apps.shaan_share.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.shaan_snaps_apps.shaan_share.transaction.action.REQUEST_WEBSHARE_STATUS";
