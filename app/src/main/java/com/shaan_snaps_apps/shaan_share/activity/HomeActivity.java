...
import com.shaan_snaps_apps.shaan_share.dialog.ShareAppDialog;
import com.shaan_snaps_apps.shaan_share.fragment.HomeFragment;
        ...
        implements NavigationView.OnNavigationItemSelectedListener, PowerfulActionModeSupport
{
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
            ...
            try {
                startActivity(new Intent(this, Class.forName("com.shaan_snaps_apps.shaan_share.activity.DonationActivity")));
